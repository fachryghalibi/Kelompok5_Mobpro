...
class _ConsultationPageState extends State<ConsultationPage> {
                  ...
                  onPressed: () {
                    setState(() {
                      ...
                      LocalNotifications.showSimpleNotification(
                        ...
                        body:
                            'Konsultasi Anda telah dijadwalkan. Kami akan mengingatkan Anda sebelum waktu konsultasi.',
  ...
  void _showBookingConfirmation(
      BuildContext context, Map<String, dynamic> doctor, String time) {
    showDialog(
      context: context,
          ...
          actions: [
            ElevatedButton(
              ...
              onPressed: () {
                ...
                // Panggil notifikasi lokal di sini
              },
            ),
          ],
        );
