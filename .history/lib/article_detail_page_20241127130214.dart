    ...
    return SliverAppBar(
      ...
      flexibleSpace: FlexibleSpaceBar(
        background: Stack(
          ...
          children: [
            CachedNetworkImage(
              imageUrl: article['imageUrl'] ?? '', // Make sure imageUrl is available
              fit: BoxFit.cover,
        ...
        SizedBox(
          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return _buildRelatedArticleCard(index);
            },
          ),
        ),
      ],
  ...
  Widget _buildRelatedArticleCard(int index) {
    return Card(
      ...
      child: Column(
        ...
        children: [
          CachedNetworkImage(
            imageUrl: 'https://via.placeholder.com/150', // Use real data here
            fit: BoxFit.cover,
            width: 150,
            height: 100,
          ),
  ...
  Widget _buildFloatingActionButtons() {
    return Column(
      ...
      children: [
        ...
        FloatingActionButton(
          onPressed: () {
            // Navigate to the top of the article
            ScaffoldMessenger.of(context).showSnackBar(
              SnackBar(content: Text('Navigating to top')),
            );
          },
