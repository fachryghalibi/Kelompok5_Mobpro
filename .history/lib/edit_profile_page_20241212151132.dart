...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  setState(() {
    _userId = prefs.getInt('user_id')?.toString();  // Mengambil user_id sebagai integer dan mengubahnya menjadi string
...
Future<void> _updateProfile() async {
  ...
  try {
    final response = await http.put(
      ...
      body: jsonEncode({
        'user_id': _userId, // Kirim user_id yang sudah diubah menjadi string
