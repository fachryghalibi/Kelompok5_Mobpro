...
class _EditProfilePageState extends State<EditProfilePage> {
  ...
  void initState() {
    ...
    setState(() {
      _nameController.text = prefs.getString('full_name') ?? 'fachryghalibi';
      _emailController.text = prefs.getString('email') ?? 'fachruddinghalibi@gmail.com';
      _phoneController.text = prefs.getString('phone_number') ?? '081234567890';
    });
  }
