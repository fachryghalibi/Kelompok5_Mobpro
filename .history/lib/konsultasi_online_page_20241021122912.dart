          ...
          SingleChildScrollView(
            child: Padding(
              padding: EdgeInsets.only(
                ...
                right: 16.0, 
                top: 16.0,
                bottom: 80.0, // Add bottom padding for the button
              ),
              child: Column(
    ...
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text('Konsultasi Anda telah berhasil dijadwalkan. Kami akan mengirimkan notifikasi pengingat sebelum waktu konsultasi.'),
          actions: [
            ElevatedButton(
              child: Text('OK'),
              onPressed: () {
