  ...
  return Container(
    ...
    child: Row(
      ...
      children: [
        ...
        // Comment Section (Dummy untuk contoh)
  ...
  Widget _buildRelatedArticles() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 12),
        _buildRelatedArticlesList(),
      ],
    );
  }

  // Related articles horizontal list
  Widget _buildRelatedArticlesList() {
    return SizedBox(
      height: 200,
    ...
    return Card(
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            CachedNetworkImage(
              imageUrl: 'https://d1vbn70lmn1nqe.cloudfront.net/prod/wp-content/uploads/2021/06/14042550/Kesehatan-Anak.jpg',
              width: 160,
              height: 120,
              fit: BoxFit.cover,
            ),
  ...
  return Padding(
    ...
    child: Row(
      ...
      children: [
        ...
        // Tombol Bookmark dengan SnackBar
        FloatingActionButton(
          heroTag: 'bookmark',
          onPressed: () {
            setState(() {
