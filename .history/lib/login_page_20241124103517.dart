...
import 'package:tubesmopro/service/login_service.dart'; // Import LoginService
...
class _LoginPageState extends State<LoginPage> {
  ...
  Future<void> _login() async {
    if (_formKey.currentState!.validate()) {
      ...
      if (data['success']) {
        // Menyimpan username jika login berhasil
        _saveUsername(_email);  // Menggunakan email sebagai username
